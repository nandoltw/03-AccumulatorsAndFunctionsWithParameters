...
#rg.Ellipse, rg.Polygon
#
#          -- Write the names of three METHODs that Circle objects have:
#circle.attach_to(), circle.clone(), circle.get_bounding_box()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#.fill_color, circle.defaults, circle.center
#
...
#        necessary?  Why?
# It's keep the window open until the user clicks which is important if there are more windows.
#
