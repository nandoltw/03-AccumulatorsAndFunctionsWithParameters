...
def draw_circles2(n):
    ...
    for k in range(n):
        circle2 = rg.Circle(rg.Point(50+(k*20),100),10)
...
def draw_circles3(n):
    ...
    for x in range(n):
        circle3 = rg.Circle(rg.Point(200,150),x+1)
...
def draw_cosines_and_sines(n):
    ...
    for x in range(n):
        circle4 = rg.Circle(rg.Point(200+(80*math.cos(x)),200+(80*math.sin(x))),10)
        circle4.attach_to(window4)
    window4.render()
